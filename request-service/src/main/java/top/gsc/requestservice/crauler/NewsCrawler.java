package top.gsc.requestservice.crauler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://nba.hupu.com/standings";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"rank_js\"]/div[3]/div[2]/table");
